<?php
/**
 * Contains code from \JamesIArmes\PhpNtlm\SoapClient.
 */
namespace jamesiarmes\PhpEws\OAuth;

/**
 * Soap Client with OAuth
 */
class SoapClient extends \SoapClient
{
    ...
    public function __construct($wsdl, array $options = null)
    {
        ...
        // Verify that token has been got.
    ...
    protected function curlOptions($action, $request)
    {
        $options = $this->options['curlopts'] + array(
            ...
            CURLOPT_XOAUTH2_BEARER => $this->options['token'],
        );
